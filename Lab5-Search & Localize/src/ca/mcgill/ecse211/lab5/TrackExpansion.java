...
public class TrackExpansion {
	...
	// wheel diameter: 4.4
	public static final double SCREW_WHEEL_RAD = 2.12;
	public static final double TANK_WHEEL_RAD = 1.67;
	public static final double TANK_TRACK = 15.7; 
	public static final double MIN_SCREW_TRACK = 15.7; // adjust from 13.7 to 18.1
	public static final double MAX_SCREW_TRACK= 25.4; //21.3 to 29.5
	 ...
	 * Considers default values to be of the screw design
	 ...
	 * 
	 * @return True if the track expanded, false if was already expanded or not expandable
	 */
	 ...
	 * 
	 * @return True if the track retracted, false if was already retracted or not expandable
	 */
	...
	/**
	 * Gets the used wheel radius previously set
	 * Default is the wheel radius of the screw design
	 * 
	...
	/**
	 * Gets the light sensor distance used depending on the design
	 * Default is the light sensor distance of the screw
	 * 
	...
	/**
	 * Method to set the robot parameters according to the design used.
	 * If the SCREW_DESIGN is given, considers the track is at its minimum.
	 * 
	 * @param robotUsed Robot design used
	 */
	 ...
	 * 
	 * @param robotUsed Robot design used
	 * @param expanded If the SCREW_DESIGN is given, 
	 * 					True for expanded will set the track to its maximum
	 */
